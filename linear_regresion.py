...
class Linear_Regression():
    ...
    def J(self, h, y):
        ...
        if h.shape != y.shape:
            ...
            # YOUR_CODE. Insert the expression of J developed in Linear_Regression_2
        # START_CODE
        J_res = (1 / (2 * len(h))) * np.sum(np.square(h - y))
        # END_CODE
...
# Cause Error RuntimeWarning: overflow encountered in reduce
# DON'T_CHANGE_THIS_CODE. It is used to let you check the result is correct
...
print(lin_reg_sklearn.score(X_test_scaled, y_test))
plt.show()